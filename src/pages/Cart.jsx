  ...
  return (
    <>
      <div className="relative">
        ...
        <div className="my-5 md:my-10 flex gap-5 flex-col md:flex-row">
          ...
          <div className="total sticky top-20 h-fit flex flex-col justify-between border border-slate-300 rounded-2xl bg-white p-5">
            <div className="flex items-center justify-between flex-wrap gap-5">
              ...
              <strong className="text-2xl text-main font-black">40302</strong>
            </div>
        ...
        <button className="bg-red-500 text-white py-2 px-4 rounded-lg mx-auto capitalize cursor-pointer hover:bg-red-500/50 block">
          remove all products
        </button>
      </div>
      <CartEmpty />
